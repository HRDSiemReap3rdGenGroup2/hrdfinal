                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" novalidate>
                                        ...
                                        <div class="item form-group">
                                            <label for="password2" class="control-label col-md-3 col-sm-3 col-xs-12">University</label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <div id="gender" class="btn-group" data-toggle="buttons">
                                                    <label class="btn btn-default parsley-success active" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input data-parsley-id="7271" data-parsley-multiple="gender" name="gender" value="male" type="radio"> &nbsp; Male &nbsp;
                                                    </label><ul id="parsley-id-multiple-gender" class="parsley-errors-list"></ul>
                                                    <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                        <input data-parsley-id="7271" data-parsley-multiple="gender" name="gender" value="female" checked="" type="radio"> Female
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
